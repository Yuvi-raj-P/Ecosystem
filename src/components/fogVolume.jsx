...
export function FogVolume({ position = [0, 0, 0], size = [10, 10, 10], opacity = 0.5 }) {
  const mesh = useRef()
  ...
  const fogMaterial = new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      void main() {
        ...
        float fogStrength = clamp(noise, 0.0, 1.0) * uOpacity;
        gl_FragColor = vec4(uColor, fogStrength * 0.3);
      }
    `,
    transparent: true,
